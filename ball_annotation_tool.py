...
class MainWindow(QMainWindow):
    ...
    def paste_annotation(self):
        """
        Ctrl+V:
        Paste all copied boxes onto the current frame at the same image-pixel
        coordinates.
        """
        ...
        # Paste at exactly the same image-pixel coordinates.
        ...
        msg = f"Pasted {len(boxes)} box(es) at the same coordinates"
